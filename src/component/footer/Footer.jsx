      ...
      <div className="container">
        <div className="box-footer">
          <div className="layanan-footer">
            <h2>Layanan</h2>
            <ul>
              <li>Laporan Keunagan</li>
              <li>Cek Stok Barang</li>
          ...
          <div className="media-sosial">
            ...
            <span>
              <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" fill="currentColor" className="bi bi-instagram" viewBox="0 0 16 16">
